...
static void emuEventCallback(Event event, void *)
{
	...
	{
		research::lua_api::setAllowed(false);
		research::lua_api::clear();
	}
	else if (event == Event::Start)
	{
		research::lua_api::setAllowed(true);
	}
...
{
	research::lua_api::registerNamespace(L);
